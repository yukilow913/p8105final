...
3) Visulization: Some visualizations include plotting our linear regression model, showing how overfitting and underfitting affects the model, creating plotly plots, and organizing all of this in a website. 

4) Coding challenge: Some of the coding challenges include making sure that the data is tidy as well as figuring out which of the predictors have the most amount of impact on our linear regression model.
